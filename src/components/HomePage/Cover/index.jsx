      ...
      <div className="relative h-screen mb-24">
        ...
        <div className="absolute flex flex-col lg:flex-row px-6 lg:p-24 items-center justify-evenly w-full h-full">
          <div className=" flex flex-col justify-center text-center pt-10 lg:pt-24 ">
            ...
            <div className="mx-auto flex justify-center w-3/5 lg:w-full">
              <img src={imageTea} alt="teaology tista sushi halden" />
            </div>
          </div>

          <div className="flex flex-col justify-center bg-white/2 backdrop-blur-md rounded-xl border border-white/30 shadow-lg ring-1 ring-white/20 p-10 md:px-36 md:py-16">
            <div>
              <h2 className="font-styling text-center text-4xl xl:text-6xl">
                Boble Te{" "}
                <span className="text-white lowercase"> er her på</span>
              </h2>
              <div className="flex justify-center mx-auto lg:pt-16 w-2/3 lg:w-full">
